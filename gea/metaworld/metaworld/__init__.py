...
class MLGrasp(Benchmark):
    def __init__(self, seed=None):
        super().__init__()
        self._train_classes = _env_dict.MLGrasp_V2['train']
        self._test_classes = _env_dict.MLGrasp_V2['test']
        train_kwargs = _env_dict.mlgrasp_train_args_kwargs
        self._train_tasks = _make_tasks(self._train_classes, train_kwargs,
                                        _ML_OVERRIDE,
                                        seed=seed)
        test_kwargs = _env_dict.mlgrasp_test_args_kwargs
        self._test_tasks = _make_tasks(self._test_classes, test_kwargs,
                                       _ML_OVERRIDE,
                                       seed=seed)
...
class MTV(Benchmark):
    def __init__(self, seed=None):
        super().__init__()
        self._train_classes = _env_dict.MTV_V2
        self._test_classes = OrderedDict()
        train_kwargs = _env_dict.MTV_V2_ARGS_KWARGS
        self._train_tasks = _make_tasks(self._train_classes, train_kwargs,
                                        _MT_OVERRIDE,
                                        seed=seed)
        self._test_tasks = []
...
class MLV(Benchmark):
    def __init__(self, seed=None):
        super().__init__()
        self._train_classes = _env_dict.MLV_V2['train']
        self._test_classes = _env_dict.MLV_V2['test']
        train_kwargs = _env_dict.mlv_train_args_kwargs
        self._train_tasks = _make_tasks(self._train_classes, train_kwargs,
                                        _ML_OVERRIDE,
                                        seed=seed)
        test_kwargs = _env_dict.mlv_test_args_kwargs
        self._test_tasks = _make_tasks(self._test_classes, test_kwargs,
                                       _ML_OVERRIDE,
                                       seed=seed)

__all__ = ["ML1", "MT1", "ML10", "MT10", "ML45", "MT50", "MTV", "MLV", "MLGrasp"]
