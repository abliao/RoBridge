...
def eye2hand(X_im=160, Y_im=120):
    ...
    # 整理两个标定点的坐标
    cali_1_im = [118, 397]                       # 左下角，第一个标定点的像素坐标，要手动填！
    cali_1_mc = [0.2904018461704254, 0.14245398342609406]                  # 左下角，第一个标定点的机械臂坐标，要手动填！
    cali_2_im = [592, 42]                         # 右上角，第二个标定点的像素坐标
    cali_2_mc = [0.6329525709152222, -0.32793495059013367]                    # 右上角，第二个标定点的机械臂坐标，要手动填！
